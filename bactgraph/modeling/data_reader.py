...
from bactgraph.modeling.dataset import BactGraphPhenoDataset, BactGraphRNADataset
...
def preprocess_data_for_training_rna(
    ...
    # create datasets
    train_dataset = BactGraphRNADataset(
    ...
    test_dataset = BactGraphRNADataset(
...
def preprocess_data_for_training_pheno(
    input_dir: str,
    ...
    genes_of_interest = list(prot_emb_genes.intersection(perturb_network_genes))
    print(f"Total nr of genes available: {len(genes_of_interest)}")
